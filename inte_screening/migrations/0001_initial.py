    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screening_consent', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Has the subject given his/her verbal consent to be screened for the INTE Africa trial?')),
                ('selection_method', models.CharField(choices=[('random_sampling', 'Random sampling'), ('purposively_selected', 'Purposively selected')], max_length=25, verbose_name='How was the patient selected for screening?')),
                ('clinic_type', models.CharField(choices=[('hiv_clinic', 'HIV Clinic'), ('ncd_clinic', 'NCD Clinic (Joint Diabetes/Hypertension)'), ('hypertension_clinic', 'Diabetes Clinic'), ('diabetes_clinic', 'Hypertension Clinic')], max_length=25, verbose_name='From which type of clinic was the patient selected')),
                ...
                ('qualifying_condition', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient have at least one of the following conditions: HIV, Diabetes and/or Hypertension')),
                ('requires_acute_care', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Does the patient require acute care including in-patient admission')),
                ('lives_nearby', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Is the patient planning to remain in the catchment area for at least 6 months')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.Site')),
                ('subject_screening', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inte_screening.SubjectScreening')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
                ('subject_screening', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='inte_screening.SubjectScreening')),
            ],
            options={

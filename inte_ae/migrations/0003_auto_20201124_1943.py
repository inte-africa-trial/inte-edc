    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_date', models.DateTimeField(validators=[edc_model.models.validators.date.date_not_future], verbose_name='Date of Death')),
                ('death_location', models.CharField(choices=[('home', 'At home'), ('hospital_clinic', 'Hospital/clinic'), ('OTHER', 'Elsewhere, please specify')], max_length=50, verbose_name='Where did the participant die?')),
                ('death_location_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('hospital_death', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=50, verbose_name='Did the participant die in hospital, or die just after visiting a hospital?')),
                ('hospital_name', models.CharField(blank=True, max_length=50, null=True, verbose_name='Which hospital was this')),
                ('informant', models.CharField(choices=[('spouse', 'Spouse'), ('Parent', 'Parent'), ('child', 'Child'), ('healthcare_worker', 'Healthcare Worker'), ('OTHER', 'Other')], max_length=50, verbose_name='Who has confirmed that the participant has died?')),
                ('informant_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('confirmed_by', models.CharField(choices=[('tel', 'Telephone conversation'), ('home', 'Home visIt'), ('relative_at_clinic', 'Relative visited the health facility'), ('patient_record', 'Patient record / document'), ('OTHER', 'Other')], max_length=50, verbose_name='How was this confirmed?')),
                ('confirmed_by_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('narrative', models.TextField(blank=True, help_text='Provide any additional details, if relevant', null=True, verbose_name='Comment')),

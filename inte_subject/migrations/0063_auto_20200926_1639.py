...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='arv_initiated',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='Yes', max_length=15, verbose_name='Has the patient started antiretroviral therapy (ART)?'),
        ),
        migrations.AddField(
            model_name='historicalhivinitialreview',
            name='arv_initiation_actual_date',
            field=models.DateField(help_text='Calculated based on response to `arv_initiation_ago`', null=True, validators=[edc_model.models.validators.date.date_not_future], verbose_name='Date started antiretroviral therapy (ART)'),
        ),
        migrations.AddField(
            model_name='historicalhivreview',
            name='arv_initiated',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', help_text='Select `not applicable` if previously reported.', max_length=15, verbose_name='Has the patient started antiretroviral therapy (ART)?'),
        ),
        migrations.AddField(
            model_name='historicalhivreview',
            name='arv_initiation_actual_date',
            field=models.DateField(null=True, verbose_name='Date started antiretroviral therapy (ART)'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='dmreview',
            name='care_start_date',
            field=models.DateField(editable=False, help_text='QUESTION_RETIRED', null=True, verbose_name='Date clinical management started'),
        ),
        migrations.AlterField(
            model_name='dmreview',
            name='dx',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', editable=False, help_text='QUESTION_RETIRED', max_length=15, verbose_name='Has the patient been diagnosed with Diabetes?'),
        ),
        migrations.AlterField(
            model_name='dmreview',
            name='managed_by',
            field=models.CharField(choices=[('insulin', 'Insulin injections'), ('drugs', 'Oral drugs'), ('diet_lifestyle', 'Diet and lifestyle alone')], default='N/A', max_length=25, verbose_name="How will the patient's diabetes be managed going forward?"),
        ),
        migrations.AlterField(
            model_name='dmreview',
            name='test_date',
            field=models.DateField(blank=True, editable=False, help_text='QUESTION_RETIRED', null=True, verbose_name='Date tested for diabetes'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='Yes', editable=False, max_length=15, verbose_name='Was the ART start date estimated?'),
        ),
        migrations.AlterField(
            model_name='historicalhivinitialreview',
            name='arv_initiation_estimated_date',
            field=models.DateField(editable=False, help_text='Calculated based on response to `arv_initiation_ago`', null=True, validators=[edc_model.models.validators.date.date_not_future], verbose_name='Estimated Date started antiretroviral therapy (ART)'),
        ),
        migrations.AlterField(
            model_name='historicalhivinitialreview',
            name='receives_care',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Is the patient receiving care for HIV?'),
        ),
        migrations.AlterField(
            model_name='historicalinvestigations',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_47476c_idx'),
        ),
        migrations.AddIndex(
            model_name='glucose',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_eae7cd_idx'),
        ),
        migrations.AddIndex(
            model_name='cd4result',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_b247cb_idx'),
        ),
    ]

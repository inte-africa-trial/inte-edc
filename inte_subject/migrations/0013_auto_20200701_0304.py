...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name="historicalreasonforvisit", name="diabetes_services_other",
        ),
        migrations.RemoveField(
            model_name="historicalreasonforvisit", name="hiv_services_other",
        ),
        migrations.RemoveField(
            model_name="historicalreasonforvisit", name="hypertension_services_other",
        ),
        migrations.RemoveField(model_name="reasonforvisit", name="diabetes_services",),
        migrations.RemoveField(
            model_name="reasonforvisit", name="diabetes_services_other",
        ),
        migrations.RemoveField(model_name="reasonforvisit", name="hiv_services",),
        migrations.RemoveField(model_name="reasonforvisit", name="hiv_services_other",),
        migrations.RemoveField(
            model_name="reasonforvisit", name="hypertension_services",
        ),
        migrations.RemoveField(
            model_name="reasonforvisit", name="hypertension_services_other",
        ),
        migrations.AddField(

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stroke_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ...
                ('heart_attack_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ...
                ('renal_disease_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ...
                ('vision_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ...
                ('numbness_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ...
                ('foot_ulcers_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
        ...
        migrations.AddField(
            ...
            name='complications',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', help_text='If Yes, complete the `Complications` CRF', max_length=15, verbose_name='Since last seen, has the patient had any complications'),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_c92cd4_idx'),
        ),
        migrations.AddIndex(

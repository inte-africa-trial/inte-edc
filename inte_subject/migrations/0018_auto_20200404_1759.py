...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=edc_model.models.fields.date_estimated.IsDateEstimatedFieldNa(blank=True, choices=[('N/A', 'Not applicable'), ('not_estimated', 'No.'), ('D', 'Yes, estimated the Day'), ('MD', 'Yes, estimated Month and Day'), ('YMD', 'Yes, estimated Year, Month and Day')], default='not_estimated', help_text='If the exact date is not known, please indicate which part of the date is estimated.', max_length=25, null=True, verbose_name='Is the dignosis date estimated'),
        ),
        migrations.AddField(

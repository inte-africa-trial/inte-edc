    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r2_taken', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='Yes', max_length=15, verbose_name='Was a <u>second</u> blood pressure reading taken')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dx_estimated_date', models.DateField(editable=False, null=True, verbose_name='Estimated hypertension diagnoses date')),
                ...
                ('med_start_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ('med_start_estimated_date', edc_model.models.fields.duration.DurationYearMonthField(editable=False, null=True)),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.Site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='inte_subject.SubjectVisit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('dx_ago', edc_model.models.fields.duration.DurationYearMonthField()),
                ('dx_estimated_date', models.DateField(editable=False, help_text='Calculated based on response to `dx_ago`', null=True, verbose_name='Estimated DX Date')),
                ...
                ('clinic_next_appt_date', models.DateField(blank=True, null=True, validators=[edc_model.models.validators.date.date_is_future], verbose_name="When is the patient's next scheduled HIV appointment")),
                ('arv_initiation_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ('arv_initiation_estimated_date', models.DateField(editable=False, help_text='Calculated based on response to `arv_initiation_ago`', null=True, validators=[edc_model.models.validators.date.date_not_future], verbose_name='Date of start of antiretroviral therapy (ART)')),
                ('has_vl', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=25, verbose_name="Is the patient's most recent viral load result available?")),
                ...
                ('other_current_arv_regimen', edc_model.models.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('current_arv_regimen', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='current_arv_regimen', to='inte_lists.ArvRegimens', verbose_name='Which antiretroviral therapy regimen is the patient currently on?')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.Site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='inte_subject.SubjectVisit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('current_arv_regimen', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='inte_lists.ArvRegimens', verbose_name='Which antiretroviral therapy regimen is the patient currently on?')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
                ('subject_visit', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='inte_subject.SubjectVisit')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smoker_quit_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('dx_ago', edc_model.models.fields.duration.DurationYearMonthField()),
                ('dx_estimated_date', models.DateField(editable=False, null=True, verbose_name='Estimated diabetes diagnoses date')),
                ('managed_by', models.CharField(choices=[('insulin', 'Insulin injections'), ('drugs', 'Oral drugs'), ('diet_lifestyle', 'Diet and lifestyle alone')], default='N/A', max_length=15, verbose_name="How is the patient's diabetes managed?")),
                ('med_start_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ('med_start_estimated_date', edc_model.models.fields.duration.DurationYearMonthField(editable=False, null=True)),
                ('glucose_performed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Has the patient had their fasting glucose measured in the last few months?')),
                ('glucose_date', models.DateField(blank=True, null=True, validators=[edc_model.models.validators.date.date_not_future])),
                ('glucose', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Fasting glucose result')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('hiv_result', models.CharField(choices=[('POS', 'Positive'), ('NEG', 'Negative'), ('NEVER', 'Never tested for HIV')], max_length=15, verbose_name="What was the result of the patient's most recent HIV test")),
                ('hiv_result_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ('hiv_result_estimated_datetime', models.DateTimeField(blank=True, editable=False, help_text='calculated by the EDC using `hiv_result_ago`', null=True)),
                ('hypertensive_tested', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Has the patient ever tested for Hypertension?')),
                ('hypertensive_tested_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ('hypertensive', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Has the patient ever been diagnosed with Hypertension')),
                ('hypertensive_tested_estimated_datetime', models.DateTimeField(blank=True, help_text='calculated by the EDC using `hypertensive_tested_ago`', null=True)),
                ('diabetic_tested', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Has the patient ever tested for Diabetes?')),
                ('diabetic_tested_ago', edc_model.models.fields.duration.DurationYearMonthField(blank=True, null=True)),
                ('diabetic', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Have you ever been diagnosed with Diabetes')),
                ('diabetes_tested_estimated_datetime', models.DateTimeField(blank=True, help_text='calculated by the EDC using `diabetic_tested_ago`', null=True)),
                ('health_insurance', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient have any private or work-place health insurance?')),
                ('patient_club', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does the patient belong to a ‘club’ that supports medicines purchase?')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_ff0844_idx'),
        ),
        migrations.AddIndex(
            model_name='indicators',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_383b3e_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_ea9ec4_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_2f6eea_idx'),
        ),
    ]

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hiv', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('unknown', 'Unknown')], max_length=15, verbose_name='Have you previously tested <u>positive</u> for HIV')),
                ('attending_hiv_clinic', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Are you receiving care at an HIV clinic')),
                ('use_hiv_clinic_nearby', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Do you attend the HIV clinic within this facility')),
                ('hiv_next_appt_date', models.DateField(blank=True, null=True, validators=[edc_model.validators.date.date_is_future], verbose_name='When is your next HIV appointment')),
                ('diabetic', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('unknown', 'Unknown')], max_length=25, verbose_name='Have you previously been diagnosed with <u>diabetes</u> (high blood sugar)?')),
                ('hypertensive', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('unknown', 'Unknown')], max_length=25, verbose_name='Have you previously been diagnosed with <u>hypertension</u> (high blood pressure)?')),
                ('attending_ncd_clinic', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Are you receiving care at an NCD clinic')),
                ('use_ncd_clinic_nearby', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Do you attend the NCD clinic within this facility')),
                ('ncd_clinic_other', models.CharField(max_length=50, null=True, verbose_name='If not in this facility, where do you attend?')),
                ('ncd_clinic_other_is_study_clinic', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', max_length=15, verbose_name='Is this NCD clinic an INTE study clinic?')),
                ('ncd_next_appt_date', models.DateField(blank=True, null=True, validators=[edc_model.validators.date.date_is_future], verbose_name='When is your next NCD appointment')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='inte_subjec_subject_0a4aa9_idx'),
        ),
    ]

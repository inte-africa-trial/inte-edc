# Generated by Django 3.0.6 on 2020-08-12 00:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("inte_subject", "0022_auto_20200730_0715"),
    ]
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        max_length=25,
                        related_name="_healtheconomicsrevised_rx_arv_recv_month_+",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        max_length=25,
                        related_name="_healtheconomicsrevised_rx_arv_recv_today_+",
                        to="inte_lists.DrugPaySources",
                        verbose_name="If YES, received ARV (HIV) drugs, how were these paid for?",
                    ),
                ),
                (
                    "rx_diabetes_recv_month",
                    models.ManyToManyField(
                        blank=True,
                        related_name="_healtheconomicsrevised_rx_diabetes_recv_month_+",
                        to="inte_lists.DrugPaySources",
                        verbose_name="If YES, received raised blood sugar (diabetes) drugs, how were these paid for?",
                    ),
                ),
                (
                    "rx_diabetes_recv_today",
                    models.ManyToManyField(
                        blank=True,
                        related_name="_healtheconomicsrevised_rx_diabetes_recv_today_+",
                        to="inte_lists.DrugPaySources",
                        verbose_name="If YES, received raised blood sugar (diabetes) drugs, how were these paid for?",
                    ),
                ),
                (
                    "rx_hypertension_recv_month",
                    models.ManyToManyField(
                        blank=True,
                        related_name="_healtheconomicsrevised_rx_hypertension_recv_month_+",
                        to="inte_lists.DrugPaySources",
                        verbose_name="If YES, received high blood pressure (Hypertension) drugs, how were these paid for?",
                    ),
                ),
                (
                    "rx_hypertension_recv_today",
                    models.ManyToManyField(
                        blank=True,
                        related_name="_healtheconomicsrevised_rx_hypertension_recv_today_+",
                        to="inte_lists.DrugPaySources",
                        verbose_name="If YES, received high blood pressure (Hypertension) drugs, how were these paid for?",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="_healtheconomicsrevised_rx_other_recv_month_+",
                        to="inte_lists.DrugPaySources",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="_healtheconomicsrevised_rx_other_recv_today_+",
                        to="inte_lists.DrugPaySources",
                        verbose_name="If YES, received 'other' drugs, how were these paid for?",
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="inte_subjec_subject_af30d8_idx",
            ),
        ),
    ]

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['id', 'display_name', 'display_index'], name='inte_lists__id_d40cbd_idx'),
        ),
        migrations.AddIndex(
            model_name='offstudyreasons',
            index=models.Index(fields=['id', 'display_name', 'display_index'], name='inte_lists__id_fbf932_idx'),
        ),
        migrations.AddIndex(
            model_name='hypertensiontreatment',
            index=models.Index(fields=['id', 'display_name', 'display_index'], name='inte_lists__id_3c3712_idx'),
        ),
        migrations.AddIndex(
            model_name='diabetestreatment',
            index=models.Index(fields=['id', 'display_name', 'display_index'], name='inte_lists__id_fa78d2_idx'),
        ),
        migrations.AddIndex(
            model_name='conditions',
            index=models.Index(fields=['id', 'display_name', 'display_index'], name='inte_lists__id_663473_idx'),
        ),
        migrations.AddIndex(
            model_name='arvregimens',
            index=models.Index(fields=['id', 'display_name', 'display_index'], name='inte_lists__id_f97923_idx'),
        ),
    ]

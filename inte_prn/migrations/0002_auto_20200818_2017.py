...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='losstofollowup',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Loss to Follow Up', 'verbose_name_plural': 'Loss to Follow Ups'},
        ),
        migrations.AlterModelOptions(
            name='protocoldeviationviolation',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Protocol Deviation/Violation', 'verbose_name_plural': 'Protocol Deviations/Violations'},
        ),
        migrations.AlterModelOptions(
            name='unblindingrequest',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Unblinding Request', 'verbose_name_plural': 'Unblinding Requests'},
        ),
        migrations.AlterModelOptions(
            name='unblindingreview',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Unblinding Review', 'verbose_name_plural': 'Unblinding Reviews'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(help_text='Optional', null=True, verbose_name='Please give a brief summary of the opportunities and challenges in getting this clinic open.')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('site',), name='unique_icc_registration'),
        ),
    ]

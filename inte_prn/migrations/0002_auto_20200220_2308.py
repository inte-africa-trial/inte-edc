...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameModel(
            ...
            new_name='HistoricalOnScheduleHiv',
        ),
        migrations.RenameModel(
            old_name='OnSchedule',
            new_name='OnScheduleHiv',
        ),
        migrations.AlterModelOptions(
            name='historicalonschedulehiv',
            options={'get_latest_by': 'history_date', 'ordering': ('-history_date', '-history_id'), 'verbose_name': 'historical on schedule hiv'},
        ),
        migrations.RemoveIndex(
            model_name='onschedulehiv',
            name='inte_prn_on_id_7e19df_idx',
        ),
        migrations.AddIndex(
            model_name='onschedulehiv',

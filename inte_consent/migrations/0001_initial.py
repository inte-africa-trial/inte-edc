    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinic_type', models.CharField(choices=[('hiv_clinic', 'HIV Clinic'), ('ncd_clinic', 'NCD Clinic (Joint Diabetes/Hypertension)'), ('hypertension_clinic', 'Diabetes Clinic'), ('diabetes_clinic', 'Hypertension Clinic')], help_text='Should match that reported on the Screening form.', max_length=25, verbose_name='In which type of clinic was the patient screened')),

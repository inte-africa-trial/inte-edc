...
crfs_unscheduled = FormsCollection(
    ...
    Crf(show_order=172, model="inte_subject.complicationsfollowup"),
    Crf(show_order=175, model="inte_subject.healtheconomicsrevised"),
    Crf(show_order=178, model="inte_subject.familyhistory"),
    Crf(show_order=180, model="inte_subject.nextappointment"),
    name="unscheduled",
...
crfs_6m = FormsCollection(
    ...
    Crf(show_order=182, model="inte_subject.complicationsfollowup", required=False),
    Crf(show_order=185, model="inte_subject.healtheconomicsrevised", required=False),
...
crfs_12m = FormsCollection(
    ...
    Crf(show_order=160, model="inte_subject.drugrefilldm", required=False),
    Crf(show_order=170, model="inte_subject.drugrefillhiv", required=False),
    Crf(show_order=172, model="inte_subject.complicationsfollowup", required=False),
    Crf(show_order=175, model="inte_subject.healtheconomicsrevised", required=False),
    Crf(show_order=178, model="inte_subject.familyhistory"),
    name="12m",
)

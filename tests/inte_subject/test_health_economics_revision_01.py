...
class TestHealthEconomicsRevision01(InteTestCaseMixin, TestCase):

    sid_count_for_tests = 1
    form_validator_default_form_cls = HealthEconomicsRevision01FormValidator
    ...
    def test_form_validator_requires_icc_registration_for_intervention(self):
        ...
        form = HealthEconomicsRevision01Form(data=cleaned_data)
        form.is_valid()
    ...
    def test_not_required_at_baseline(self):
        ...
        self.assertNotIn(
            "inte_subject.healtheconomicsrevision01", [o.model for o in crfs.all()]
        )

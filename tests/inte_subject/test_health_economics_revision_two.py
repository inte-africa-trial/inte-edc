...
class TestHealthEconomicsRevisionTwo(InteTestCaseMixin, TestCase):

    sid_count_for_tests = 1
    form_validator_default_form_cls = HealthEconomicsRevisionTwoFormValidator
    ...
    def test_form_validator_requires_icc_registration_for_intervention(self):
        ...
        form = HealthEconomicsRevisionTwoForm(data=cleaned_data)
        form.is_valid()
    ...
    def test_not_required_at_baseline(self):
        ...
        self.assertNotIn(
            "inte_subject.healtheconomicsrevisiontwo", [o.model for o in crfs.all()]
        )
    ...
    def test_not_required_6m_visit_if_completed_previously(self):
        ...
        baker.make("inte_subject.healtheconomicsrevisiontwo", subject_visit=subject_visit)
    ...
    @tag("he-r02")
    def test_not_required_6m_visit_if_he_revision_one_completed_previously(self):
        self.subject_visit.appointment.appt_status = INCOMPLETE_APPT
        self.subject_visit.appointment.save()
        self.subject_visit.appointment.refresh_from_db()
